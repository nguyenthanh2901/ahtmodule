...
class GenericButton
{
    ...
    public function getQuestionId()
    {
        try {
            ...
            $this->questionResource->load($question, $this->context->getRequest()->getParam('question_id'));
            if (!$question->getId()) {
                throw new NoSuchEntityException(__('The CMS block with the "%1" ID doesn\'t exist.', $this->context->getRequest()->getParam('question_id')));
            }
